...
Beisde of the training dataset with the batch_size=32, we set batch_size=1 tp all the other 
datasets. 
"""
...
# Set the GPU growth to avoid the sudden stop of the runtime.
...
# It is test generator as similar as the above. 
